...
const seedDatabase = async () => {
  try {
    ...
    const u3 = await User.create({
      ...
      role: 'USER',
      status: 'ACTIVE',
      avatarUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=gamepro',
      referralCode: 'PRO999',
      stats: { played: 10, won: 8, lost: 2, totalWinningsPaise: 90000 }
    });
    ...
    await Wallet.create({ userId: u3._id, depositBalance: 10000, winningBalance: 30000, bonusBalance: 500 });
    ...
    await WithdrawalRequest.create({
      ...
      mobile: u1.mobile,
      amountPaise: 50000, // ₹500 (100% net amount, no TDS)
      payoutMethod: 'UPI',
    ...
    await WithdrawalRequest.create({
      ...
      mobile: u2.mobile,
      amountPaise: 100000, // ₹1000 (100% net amount)
      payoutMethod: 'BANK_TRANSFER',
      accountDetails: { accountNumber: '918273645012', ifscCode: 'SBIN0001234', accountHolderName: 'Ludo Master' },
      status: 'PENDING_APPROVAL',
      riskScore: 'MEDIUM'
    });
    ...
    const match1 = await Match.create({
      ...
      gameMode: 'CLASSIC',
      entryFee: 50000, // ₹500
      prizePool: 90000, // ₹900 (after 10% commission on ₹1000 pool)
      players: [
    ...
    await AdminAuditLog.create({
      ...
      action: 'ADMIN_LOGIN',
      details: 'Database seeded with default superadmin and test dataset',
